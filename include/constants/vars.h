...
#define VAR_RANGER_RANK                                  0x40F7 // Laekon: Ranger star rank, 0-3. See constants/ranger_rank.h. Gates map access/NPC behavior region-wide -- never use badge flags for this.
